...
function addProductPage(product_id) {
  fetch("http://localhost:9000/product/${product_id}" {
      "methods": "GET",
      headers: {
    ...
    return (<p>Halooooooo product page</p>)
}
...
function App() {
  ...
  <>
    <Layout
      style={{background: "#303e45", color: "#bfced6"}}
    >
      <Title style={{color: "#bfced6"}}><center>Simple Marketplace</center></Title>
    </Layout>
...
function product() {
  return <h1>product page nich</h1>;
}
