...
# Image Endpoints
image_router.add_url_rule("/product/update-logo/<int:product_id>", view_func=image_view.update_product_logo_view, methods=["PUT"])
...
# Variant Endpoints
variant_router.add_url_rule("/list/<int:product_id>", view_func=variant_view.get_variant_list_view, methods=["GET"])
variant_router.add_url_rule("/<int:variant_id>", view_func=variant_view.get_variant_view, methods=["GET"])
variant_router.add_url_rule("/add/<int:product_id>", view_func=variant_view.create_variant_view, methods=["POST"])
